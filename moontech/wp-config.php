...
define( 'WPCACHEHOME', '/home/c2830205/public_html/moontech/wp-content/plugins/wp-super-cache/' );
$sDestDir = '/home/c2830205/public_html/moontech';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'c2830205_moontech');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'c2830205_moontec');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'zpptukn0Aqlogah');
